...
import sap.s4hana.salesarea_0001.mock as _;
...
function testListA_SalesOrder() returns error? {
    CollectionOfSalesArea areas = check s4HanaClient->listSalesAreas();
    test:assertTrue(areas.value !is (), "Sales area list length mismatch");
}
