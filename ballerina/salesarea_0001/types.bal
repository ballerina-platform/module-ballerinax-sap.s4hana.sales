...
# Represents the Queries record for the operation: getSalesArea
public type GetSalesAreaQueries record {
...
public type SalesAreaSelectOptions ("SalesOrganization"|"DistributionChannel"|"Division")[];
...
# Represents the Queries record for the operation: listSalesAreas
public type ListSalesAreasQueries record {
    ...
    SalesAreaOrderByOptions \$orderby?;
...
public type SalesAreaOrderByOptions ("SalesOrganization"|"SalesOrganization desc"|"DistributionChannel"|"DistributionChannel desc"|"Division"|"Division desc")[];
...
public type CollectionOfSalesArea record {
    count \@odata\.count?;
    SalesArea[] value?;
};
