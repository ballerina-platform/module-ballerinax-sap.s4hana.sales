...
service /sap/opu/odata/sap/API_SD_INCOTERMS_SRV on ep0 {
    ...
    # http:Response (Error)
    resource function get A_IncotermsClassification(int? \$top, int? \$skip, string? \$filter, "allpages"|"none"? \$inlinecount, A_IncotermsClassificationOrderByOptions? \$orderby, A_IncotermsClassificationSelectOptions? \$select, A_IncotermsClassificationExpandOptions? \$expand) returns CollectionOfA_IncotermsClassificationWrapper|http:Response {
        return {
            d: {
                results: [
                    {
