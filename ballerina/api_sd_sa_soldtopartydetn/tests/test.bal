...
import sap.s4hana.api_sd_sa_soldtopartydetn.mock as _;
...
function testListA_SalesOrder() returns error? {
    CollectionOfA_DelivSchedSoldToPartyDetnWrapper listA_SalesOrders = check s4HanaClient->listA_DelivSchedSoldToPartyDetns();
