...
service /sap/opu/odata/sap/API_SD_SA_SOLDTOPARTYDETN on ep0 {
    ...
    # http:Response (Error)
    resource function get A_DelivSchedSoldToPartyDetn(int? \$top, int? \$skip, string? \$filter, "allpages"|"none"? \$inlinecount, A_DelivSchedSoldToPartyDetnOrderByOptions? \$orderby, A_DelivSchedSoldToPartyDetnSelectOptions? \$select) returns CollectionOfA_DelivSchedSoldToPartyDetnWrapper|http:Response {
        return {
            d: {
                results: [
                    {
