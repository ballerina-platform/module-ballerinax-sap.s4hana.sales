...
import sap.s4hana.api_sales_order_simulation_srv.mock as _;
...
function testCreateSalesOrderSimulation() {
    string salesOrderId = "5999998";
    A_SalesOrderSimulationWrapper|error salesOrder = s4HanaClient->createA_SalesOrderSimulation({
    ...
    test:assertTrue(salesOrder is error, "The sales order simulation response expected to be 500");
